        ...
        <>
            <div className='h-[30rem] md:h-[30rem] gap-10 md:gap-15 flex flex-col justify-end items-center'>
                ...
                <div className='dark:bg-[var(--color-bg-dark)] gap-5 h-60 md:h-70 dark:border-[#2d2f38] bg-[#ffffff] border border-[#c8c8c8] w-3/4 md:w-1/4 flex flex-col justify-center items-center rounded-[5px] px-5 py-[13px] text-base font-medium text-[#787878] dark:text-white'>
                    ...
                    <button className='bg-[#efefef] border border-[#c9c7c7] dark:border-0 dark:bg-[#293749] hover:dark:bg-[var(--color-bg-light-dark)] dark:text-white rounded-md px-4 py-2'>Login with google</button>
                </div>
            </div>
        </>
    )
