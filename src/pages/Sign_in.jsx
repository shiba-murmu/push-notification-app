        ...
        <>
            <div className='h-[30rem] md:h-[35rem]  gap-10 md:gap-15 flex flex-col justify-end items-center'>
                ...
                <div className='dark:bg-[var(--color-bg-dark)] gap-5 md:gap-10 h-60 md:h-96 dark:border-[#2d2f38] bg-[#ffffff] border border-[#c8c8c8] w-3/4 md:w-1/4 flex flex-col justify-center items-center rounded-2xl px-5 py-[13px] text-base font-medium text-[#787878] dark:text-white'>
                    ...
                    <Button_tap_animate>
                        <button className='bg-[#efefef] border border-[#c9c7c7] dark:border-0 dark:bg-[#293749] hover:cursor-pointer hover:dark:bg-[var(--color-bg-light-dark)] dark:text-white rounded-md px-4 py-2'>Login with google</button>
                    </Button_tap_animate>
                </div>
            </div>
        </>
